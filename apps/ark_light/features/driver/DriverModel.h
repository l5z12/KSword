...
// DriverModel.h
// Purpose:
// 1) Defines a read-only display model for driver overview and object information;
// 2) Provide filtering, aggregation, and text formatting utilities;
// 3) Contains no Win32 control, device I/O, or driver call logic.
// ============================================================
