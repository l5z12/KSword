...
enum class KToastKind { kInfo, kSuccess, kWarning, kDanger };
...
public:
    ...
    void showAt(int rootX, int rootY, const char* text = nullptr);
...
public:
    ...
    void showAt(int rootX, int rootY);
...
enum class KDrawerSide { kLeft, kRight, kTop, kBottom };
