...
enum class StartupEntryKind {
    ...
    kRegistryOnlyService,
    kScheduledTaskFacade
};
...
struct StartupEntry {
    StartupEntryKind kind = StartupEntryKind::kRegistryRun;
    StartupEntryScope scope = StartupEntryScope::kUnknown;
    StartupEntryState state = StartupEntryState::kUnknown;
    std::wstring name;
    std::wstring command;
