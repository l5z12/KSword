...
private:
    ...
    std::string title_;
    std::unique_ptr<Fl_Image> iconImage_;
    std::unique_ptr<Fl_Image> iconScaled_;
    std::unique_ptr<Fl_Image> logoImage_;
    std::unique_ptr<Fl_Image> logoScaled_;
};
...
bool kInstallTitleBar(Fl_Window* window, KTitleBarStyle style = KTitleBarStyle::kTrapezoid, bool showMaximize = true);
