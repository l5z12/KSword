...
private:
    ...
    int itemAt(int mouseX, int mouseY) const;
...
private:
    ...
    int cardAt(int mouseX, int mouseY) const;
...
private:
    ...
    int sectionAt(int mouseY) const;
