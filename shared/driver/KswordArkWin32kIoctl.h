...
// Message-hook Session/PID/TID filters can be evaluated against the installing
// thread (owner), the hooked thread (target), or both. Keeping both selector
// bits clear preserves the legacy owner-or-target matching behavior.
#define KSWORD_ARK_WIN32K_MESSAGE_HOOK_QUERY_FLAG_MATCH_OWNER  0x00000004UL
#define KSWORD_ARK_WIN32K_MESSAGE_HOOK_QUERY_FLAG_MATCH_TARGET 0x00000008UL
#define KSWORD_ARK_WIN32K_MESSAGE_HOOK_QUERY_FLAG_MATCH_MASK \
    (KSWORD_ARK_WIN32K_MESSAGE_HOOK_QUERY_FLAG_MATCH_OWNER | \
...
#define KSWORD_ARK_WIN32K_MESSAGE_HOOK_DEFAULT_MAX_ENTRIES 4096UL
