...
public:
    ...
    static Fl_Image* loadThemedSvg(const std::string& name, KIconColorRole role = KIconColorRole::kPrimary, int size = 24);
    ...
    static std::string themedSvgText(const std::string& name, KIconColorRole role = KIconColorRole::kPrimary);
    ...
    static bool cached(const std::string& name, KIconColorRole role = KIconColorRole::kPrimary, int size = 24);
