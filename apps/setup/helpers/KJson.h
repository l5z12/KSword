...
public:
    ...
    enum ParseError {
        kNoError,
        kUnterminatedString,
        kMissingNameSeparator,
        kMissingValueSeparator,
        kIllegalValue,
        kIllegalNumber,
        kIllegalEscapeSequence,
        kIllegalUtF8String,
        kDeepNesting,
        kGarbageAtEnd,
        kUnknownError
...
public:
    ...
    std::string toJson(KJsonFormat format = KJsonFormat::kCompact) const;
...
private:
    ...
    std::shared_ptr<KJsonArray> arrayValue_;
    std::shared_ptr<KJsonObject> objectValue_;
};
...
public:
    ...
    typedef std::vector<KJsonValue>::const_iterator ConstIterator;
...
public:
    ...
    typedef std::map<std::string, KJsonValue>::const_iterator ConstIterator;
...
private:
    ...
    std::map<std::string, KJsonValue> values_;
};
