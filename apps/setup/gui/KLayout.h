...
struct KSize {
    ...
    KSize(int widthValue = 0, int heightValue = 0);
...
struct KMargins {
    ...
    KMargins(int leftValue = 0, int topValue = 0, int rightValue = 0, int bottomValue = 0);
...
public:
    ...
    KSizePolicy(KSizePolicyType horizontal = KSizePolicyType::kFill,
        KSizePolicyType vertical = KSizePolicyType::kFill,
    ...
    static KSizePolicy expanding(int horizontalStretch = 1, int verticalStretch = 1);
    static KSizePolicy fill(int horizontalStretch = 1, int verticalStretch = 1);
...
private:
    KSizePolicyType horizontalPolicy_;
    KSizePolicyType verticalPolicy_;
    int horizontalStretch_;
    int verticalStretch_;
};
...
struct KLayoutItem {
    ...
    explicit KLayoutItem(Fl_Widget* widgetValue);

    Fl_Widget* widget;
    KSizePolicy sizePolicy;
    KSize minimumSize;
    KSize preferredSize;
    KSize maximumSize;
    int stretch;
...
public:
    ...
    void addWidget(Fl_Widget* widget, int row, int column, int rowSpan = 1, int columnSpan = 1, int stretch = 0);
...
private:
    ...
    KMargins margins_;
    bool dirty_;
    std::vector<int> rowStretches_;
    std::vector<int> columnStretches_;
    std::vector<int> rowMinimumHeights_;
    std::vector<int> columnMinimumWidths_;
    std::vector<KLayoutItem> items_;
};
...
enum class KSplitterPaneOrientation { kHorizontal, kVertical };
